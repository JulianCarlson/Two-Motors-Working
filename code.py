...
while True:
    Left_Motor_speed = 0.5 # Tells left wheel to spin forwards
    Left_Motor.throttle = Left_Motor_speed
    Right_Motor_speed = 0.5 # Tells right wheel to spin forwards
    Right_Motor.throttle = Right_Motor_speed
    time.sleep(2)
    Left_Motor_speed = -0.5 # Tells left wheel to spin backwards
    Left_Motor.throttle = Left_Motor_speed
    Right_Motor_speed = -0.5 # Tells right wheel to spin backwards
    Right_Motor.throttle = Right_Motor_speed
    time.sleep(2)
    Left_Motor_speed = 0.5 # Tells left wheel to spin left
    Left_Motor.throttle = Left_Motor_speed
    Right_Motor_speed = -0.5 # Tells right wheel to spin left
    Right_Motor.throttle = Right_Motor_speed
    time.sleep(2)
    Left_Motor_speed = -0.5 # Tells left wheel to spin right
    Left_Motor.throttle = Left_Motor_speed
    Right_Motor_speed = 0.5 # Tells right wheel to spin right
    Right_Motor.throttle = Right_Motor_speed
    time.sleep(2)
